...
#include "dummy_with_tcp_break_imitator_global.h"
...
extern "C" {
    ...
    DUMMY_IMITATOR_WITH_TCP_BREAK_EXPORT modus::SvAbstractProtocol* create();
...
namespace apak {
  ...
  private:
    ...
    // Cчётчик принятых сообщений;
   quint8 m_receivedMessageCounter;
  ...
  private slots:
    ...
    void messageFrom_DUMMY(modus::BUFF* buffer);
  };
}
