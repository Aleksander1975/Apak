...
DEFINES += DUMMY_IMITATOR_WITH_TCP_BREAK_LIBRARY

CONFIG += c++11 plugin

TARGET = /home/user/Modus/lib/protocols/apak_dummy_with_tcp_break_imitator
TEMPLATE = lib
...
SOURCES += \
    ...
    dummy_with_tcp_break_imitator.cpp
...
HEADERS += \
    ...
    protocol_params.h \
    dummy_with_tcp_break_imitator.h \
    dummy_with_tcp_break_imitator_global.h
