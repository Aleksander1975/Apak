...
#include "ui_select_system_dialog.h"
...
class ZNSystemSelectDialog : public QDialog
{
    Q_OBJECT
  ...
  public:
    ...
    explicit ZNSystemSelectDialog(QWidget *parent, const QString& json);
    ~ZNSystemSelectDialog();

    QString selectedRecord() { return m_selected_record; }
...
private:
    ...
    QString    m_selected_record;
    QJsonObject m_configuration;
    QString     m_last_error = "";

    QMap<int, QString> m_records;
